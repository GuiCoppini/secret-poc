        ...
        public void paintComponent(Graphics g) {
            ...
            for(int row = 0; row < ROWS; row++) {
                for(int col = 0; col < COLUMNS; col++) {
                    ...
                    g.fillOval(col * colWidth + colOffset, row * rowHeight + rowOffset, colWidth - 2 * colOffset, rowHeight - 2 * rowOffset);
                }
            }
        }
    }
        ...
        SwingWorker<Color, ?> worker = new SwingWorker<Color, Object>() {
            ...
            protected void done() {
                ...
                if(winner == HUMAN) {
                    ...
                    JOptionPane.showMessageDialog(null, "Human Wins!", "Game Over", JOptionPane.INFORMATION_MESSAGE);
